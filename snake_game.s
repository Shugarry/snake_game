...
mode_select_input:
    ...
    la t0, input	# check keypress
	#TODO: CHECK IF INPUT IS READY AND THEN EXTRACT DATA
	lw t0, 4(t0)
	lw t0, 0(t0)
...
difficulty_select:
	...
	j difficulty_select_input

difficulty_select_input:
	li a0, 100 # 100 ms delay
	li a7, 32
	ecall
	...
	li t3, 200
	sw t3, 0(t2)
	beq t0, t1, difficulty_select_end
	li t1, 50 # '2' ascii
	li t3, 100
	sw t3, 0(t2)
	beq t0, t1, difficulty_select_end
